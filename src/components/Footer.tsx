          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                <a href="https://wa.me/254700000000" target="_blank" rel="noopener noreferrer" className="social-btn whatsapp" aria-label="WhatsApp">
                ...
                <a href="tel:+254700000000" className="social-btn call" aria-label="Call">
