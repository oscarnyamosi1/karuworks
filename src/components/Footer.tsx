          ...
          <div className="footer-grid">
            <div className="footer-brand">
              ...
              <div className="footer-social">
                <a href="https://wa.me/2547084588281" target="_blank" rel="noopener noreferrer" className="social-btn whatsapp" aria-label="WhatsApp">
                ...
                <a href="tel:+2547084588281" className="social-btn call" aria-label="Call">
            ...
            <div className="footer-col">
              ...
              <ul className="footer-contact">
                <li>
                  ...
                  <a href="tel:+2547084588281">+254 708 458 8281</a>
                </li>
                <li>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <a href="mailto:info@karuworks.co.ke">info@karuworks.co.ke</a>
                </li>
                <li>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
